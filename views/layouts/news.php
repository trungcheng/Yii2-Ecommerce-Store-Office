...
$listnew = News::find()->where(['deleted'=>0])->orderBy('news_id DESC')->limit(8)->all();
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="vi">
                ...
                <div class="col-md-3 sidebar">
                    <div class="cart">
                        <div class="title-sidebar">
                            <p>Tin tức văn phòng</p>
                        </div>
                        <div class="box-giohang">
                            <ul class="tinnoibat">
                                <?php foreach($listnew as $list){
                                ?>
                                <li><a href="<?= Yii::$app->homeUrl ?>new/detail?id=<?= $list->news_id ?>"><?= $list->news_title ?></a></li>
                                <?php
                                } ?>
                            </ul>
                        </div>
